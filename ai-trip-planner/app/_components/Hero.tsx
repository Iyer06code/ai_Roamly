        ...
        <div className='mt-24 flex items-center justify-center'>
            ...
            <div className='max-w-3xl w-full text-center space-y-6'>
                <h1 className='text-xl md:text-5xl font-bold'>
                    Hey, I'm your <span className='text-primary'>AI Trip Planner</span>
                </h1>
                <p className='text-md md:text-md mt-4'>
                    Plan your next trip with ease. Just tell me where you want to go and I'll
                    take care of the rest: Flights, Hotels, Trip Planner - all in seconds
                </p>
                ...
                <div className='flex gap-1.5'>
                    {suggestions.map((suggestion, index) => (
                        <div
                            key={index}
                            className='flex items-center gap-2 border-2 border-muted rounded-full p-4 mt-4 cursor-pointer hover:bg-primary hover:text-white transition-colors'
                        >
                            {suggestion.icon}
                ...
                <div className='flex items-center justify-center flex-col'>
                    <h2 className='my-7 mt-14 flex gap-2 items-center'>
